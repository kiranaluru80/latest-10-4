...
namespace ReadDataFromJson
{
	public class ReadDataViewModel : ViewModelBase
	{
		...
		bool _popOverListview;
		public bool PopOverListview
		{
			get { return _popOverListview; }
			set
			{
				if (_popOverListview != value)
				{
					_popOverListview = value;
					OnPropertyChanged("PopOverListview");
				}
			}
		}
		...
		PickerData selectedMajorGroup; //Organization
		public PickerData SelectedMajorGroup //Organization
		{
